...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">We sent you an activation code. Check your email and click on the link to verify!</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'khalid05061997@gmail.com';
        $config['smtp_pass'] = 'Aljabar94';
        ...
        $this->email->from('khalid05061997@gmail.com', 'Sistem Pakar Indihome');
