...
class Manageuseetv extends CI_Controller
{
    ...
    public function tambahgangguan()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Useetv_model->tambahDataGangguan($id_user);
    ...
    public function ubahgangguan($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Useetv_model->ubahDataGangguan($id_user);
            if ($data['user']['role_id'] == 3) {
                $this->session->set_flashdata('flash', 'Diajukan ke Pakar');
            } else {
    ...
    public function tambahgejala()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Useetv_model->tambahDataGejala($id_user);
            if ($data['user']['role_id'] == 3) {
                $this->session->set_flashdata('flash', 'Diajukan ke Pakar');
            } else {
                $this->session->set_flashdata('flash', 'Ditambahkan');
    ...
    public function ubahgejala($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Useetv_model->ubahDataGejala($id_user);
            if ($data['user']['role_id'] == 3) {
                $this->session->set_flashdata('flash', 'Diajukan ke Pakar');
            } else {
                $this->session->set_flashdata('flash', 'Diubah');
