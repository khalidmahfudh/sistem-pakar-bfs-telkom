                        ...
                        <div class="form-wrap">
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label" id="label">
                                    <input class="form-check-input" type="radio" name="radio1" id="radio<?= $question['id'] ?>1" style="height: 30px; width: 30px;" value="<?= $question['kode_gejala'] ?>-1-3" checked>
                                    <h5>YA</h5>
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="radio1" id="radio<?= $question['id'] ?>2" style="height: 30px; width: 30px;" value="<?= $question['kode_gejala'] ?>-2-3">
                                    <h5>TIDAK</h5>
                                </label>
                            </div>
                        </div>
