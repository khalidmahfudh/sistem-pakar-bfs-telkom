...
<div class="container bg-div pt-3 pb-3 py-5" style="height: 80%">
    <div class="row">
        <a href="<?= base_url('konsultasiinternet/diagnosa/first');  ?>" class="btn1-signal btn btn-danger btn-lg text-light my-4 mx-auto"><i class="fas fa-stethoscope"></i> DIAGNOSA SEKARANG</a>
    </div>
        ...
        <div class="list-group mx-auto my-2">
            ...
            <div class="list-wrap animated--grow-in">
                <?php foreach ($gangguan as $g) : ?>
                    <a href="<?= base_url('konsultasiinternet/detail/' . $g['id']); ?>" class=" list-group-item list-group-item-action list-group-item-<?= $colors[$i++]; ?> text-gray-900"><?= $g['nama_gangguan']; ?></a>
                    <?php if ($i == 7) $i = 0; ?>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <div class="row">
            <img src="<?= base_url('assets/img/internet2.png') ?>" alt="logo" class="img-signal mx-auto d-block my-4 mx-auto">
    </div>
