...
$this->db->join('data_gejala_telepon', 'data_gejala_telepon.kode_gejala = gejala_gangguan_telepon.kode_gejala');
$this->db->where(array('gejala_gangguan_telepon.kode_gangguan' => $gangguanById['kode_gangguan']));
            ...
            <div class="row text-gray-900">
                ...
                <div class="col-sm">
                    <div class="card border-dark mb-4 btncont" style="background-color: #F8B195;">
                        <img class="img-gangguan" src="<?= base_url('assets/img/telepon.jpg') ?>" alt="telepon">
