...
<div class="container-fluid">
    ...
    <nav class="title">
        ...
        <h1 class="h3 text-dark text-center">Daftar Gangguan Pada Layanan Telepon Rumah Indihome</h1>
    </nav>
    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            <a href="<?= base_url('managetelepon'); ?>" class="btn btn-dark" title="back"><i class="fas fa-angle-double-left"></i></a>
            <a href="<?= base_url('managetelepon/tambahgangguan'); ?>" class="btn btn-dark">Tambah Data Gangguan</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a class="badge badge-warning action text-dark mr-2" href="<?= base_url(); ?>managetelepon/ubahgangguan/<?= $g['id']; ?>" title="ubah data">
                                        <i class="fas fa-fw fa-edit"></i>Edit
                                    </a>
                                    <a class="badge badge-danger action text-dark" href="<?= base_url(); ?>managetelepon/hapusgangguan/<?= $g['id']; ?>/<?= $g['kode_gangguan']; ?>" title="hapus data" onclick="return confirm('yakin menghapus <?= $g['nama_gangguan']; ?>?');">
