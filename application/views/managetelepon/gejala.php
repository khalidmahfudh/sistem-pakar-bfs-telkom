...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            ...
            <a href="<?= base_url('managetelepon/tambahgejala'); ?>" class="btn btn-dark">Tambah Data Gejala</a>
        </div>
    </div>
    ...
    <form action="" method="post">
        <div class="input-group mb-3 col-lg-5 row">
            ...
            <div class="input-group-append">
                ...
                <a href="<?= base_url('managetelepon/gejala'); ?>" class="btn btn-dark ml-2" type="reset" name="reset" title="reset"><i class="fas fa-sync-alt"></i></a>
            </div>
        </div>
    </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a class="badge badge-danger action text-dark" href="<?= base_url(); ?>managetelepon/hapusgejala/<?= $g['id']; ?>" title="hapus data" onclick="return confirm('yakin menghapus <?= $g['nama_gejala']; ?>?');">
