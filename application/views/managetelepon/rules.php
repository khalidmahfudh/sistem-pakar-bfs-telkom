...
<div class="container-fluid">
        ...
        <div class="row mt-3">
            <div class="col-md-7">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    RULES Gangguan Telepon <strong>berhasil</strong> <?= $this->session->flashdata('flash'); ?>.
                    <a href="<?= base_url('konsultasitelepon/detail'); ?>/<?= $this->session->userdata('id_gangguan'); ?>">List Gejala</a>
    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            <a href="<?= base_url('managetelepon'); ?>" class="btn btn-dark" title="back"><i class="fas fa-angle-double-left"> kembali</i></a>
        </div>
    </div>
    ...
    $this->db->where(array('gejala_gangguan_telepon.kode_gangguan' => $kode));
                ...
                <div class="card-body">
                    ...
                    <?php if (isset($_POST['submit2'])) :
                        ...
                        if ($user['role_id'] == 3) {
                            ...
                            $nama_gangguan = $this->db->get_where('data_gangguan_telepon', ['id' => $_SESSION['id_gangguan']])->row_array();
                            ...
                            redirect('managetelepon/rules');
                        } else {


                            $this->db->delete('gejala_gangguan_telepon', ['kode_gangguan' => $_POST['kode_gangguan']]);
