...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            ...
            <a href="<?= base_url('manageuseetv/tambahgejala'); ?>" class="btn btn-dark">Tambah Data Gejala</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a class="badge badge-warning action text-dark mr-2" href="<?= base_url(); ?>manageuseetv/ubahgejala/<?= $g['id']; ?>" title="ubah data">
                                        <i class="fas fa-fw fa-edit"></i>Edit
                                    </a>


                                    <a class="badge badge-danger action text-dark" href="<?= base_url(); ?>manageuseetv/hapusgejala/<?= $g['id']; ?>" title="hapus data" onclick="return confirm('yakin menghapus <?= $g['nama_gejala']; ?>?');">
